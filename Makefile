...
#    Updated: 2025/02/26 16:46:02 by nopareti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC         = main.c parsing/map.c parsing/args.c parsing/cardinals.c \
				...
				raycasting/raycasting.c render.c utils/file.c utils/check.c \
				player/player.c utils/utils_functions.c player/player_rotate.c \
				player/player_movements.c raycasting/init_values.c raycasting/dda.c \
				keys_handler.c
